...
const Banner = () => {
  ...
  return (
    <div className="relative bg-gradient-to-r from-orange-100 via-yellow-50 to-red-100 
    animate-gradient-x pt-12 md:pt-24 min-h-[500px] flex items-center justify-center">
    
    {/* Gradient Animation */}
    <div className="absolute inset-0 bg-gradient-to-r from-orange-300 via-yellow-200 to-red-300 
    opacity-40 blur-3xl animate-pulse"></div>
    ...
    <div className="container mx-auto px-6 md:px-12 xl:px-20 flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
      {/* LEFT CONTENT */}
        ...
        <div className="flex flex-wrap justify-center lg:justify-start gap-4">
          ...
          onClick={() => setShowVideo(true)}>
            ...
            justify-center transition group-hover:bg-red-600 group-hover:scale-110 shadow-lg relative">
              <span className="absolute inset-1.5 animate-ping rounded-full bg-red-400 opacity-75"></span>
      ...
      <div className="w-full lg:flex-1 relative max-w-sm sm:max-w-md md:max-w-lg lg:max-w-none mx-auto">
        <div className="relative mx-auto">
          <img src={Bannerphonepic} alt="Banner Phonepic" className="w-[300px] md:w-[400px] lg:w-[500px] h-auto object-cover transition duration-500"/>
        </div>
      </div>
    </div>
  </div>
